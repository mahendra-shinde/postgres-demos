CREATE TABLE agents (
  ...
  COMMISSION NUMERIC(10,2) DEFAULT NULL,
...
CREATE TABLE daysorder (
  ...
  CONSTRAINT AG_3 FOREIGN KEY (AGENT_CODE) REFERENCES agents(AGENT_CODE)
);
...
('200115', '2000.00', '1200.00', '2008-02-08', 'C00013', 'A011', 'SOD\r'),
('200101', '3000.00', '1000.00', '2008-07-15', 'C00001', 'A008', 'SOD\r'),
('200128', '3500.00', '1500.00', '2008-07-20', 'C00009', 'A002', 'SOD\r'),
('200132', '4000.00', '1500.00', '2008-08-15', 'C00013', 'A012', 'SOD\r');
...
CREATE TABLE despatch (
  ...
  AGENT_CODE varchar(6) DEFAULT NULL,
  PRIMARY KEY (DES_NUM),
  CONSTRAINT AG_2 FOREIGN KEY (AGENT_CODE) REFERENCES agents(AGENT_CODE)
); 
...
CREATE TABLE  orders (
  ...
  AGENT_CODE varchar(6) NOT NULL,
  ORD_DESCRIPTION varchar(60) NOT NULL,
  CONSTRAINT AG_1 FOREIGN KEY (AGENT_CODE) REFERENCES agents(AGENT_CODE)
);
...
('200132', '4000.00', '2000.00', '2008-08-15', 'C00013', 'A011', 'SOD\r');
...
CREATE TABLE studentreport (
  ...
  CONSTRAINT FK_CSR FOREIGN KEY (CLASS, SECTION, ROLLID)
    REFERENCES student (CLASS, SECTION, ROLLID)
);
