...
CREATE TABLE daysorder (
  ...
  CONSTRAINT AG_3 KEY (AGENT_CODE) REFERENCES agent(AGENT_CODE)
);
...
CREATE TABLE despatch (
  ...
  AGENT_CODE varchar(6) DEFAULT NULL,
  PRIMARY KEY (DES_NUM),
  CONSTRAINT AG_2 KEY (AGENT_CODE) REFERENCES agent(AGENT_CODE)
); 
...
CREATE TABLE  orders (
  ...
  AGENT_CODE varchar(6) NOT NULL,
  ORD_DESCRIPTION varchar(60) NOT NULL,
  CONSTRAINT AG_1 KEY (AGENT_CODE) REFERENCES agent(AGENT_CODE)
);
